/*
        ...
        **first intution**
comes in mind is to just make a duplicate sorted array and compare with original one.
   T.C = O(nlogn);
   S.C = O(n);
---------------------------------------------------------------------------   
           ** second Intution**
           maintain two arrays, 
       one =>    maximum from left  &
       second => minimum from right;
       
       iterate from both ends (comparing with original array);
